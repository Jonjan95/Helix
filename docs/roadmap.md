...
## 4. Transition into the digital journey
...
- Add real project data, imagery, roles, decisions, and outcomes.
- Design reusable case-study patterns only after content needs are known.
- Provide direct navigation to individual work.
